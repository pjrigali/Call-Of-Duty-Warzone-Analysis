MU_LST = ['headshots', 'kills', 'deaths', 'longestStreak', 'scorePerMinute', 'distanceTraveled',
          ...
          'objectiveTeamWiped', 'objectiveBrDownEnemyCircle1', 'objectiveBrDownEnemyCircle2',
          'objectiveBrDownEnemyCircle3', 'objectiveBrDownEnemyCircle4', 'objectiveBrDownEnemyCircle5',
          'objectiveBrDownEnemyCircle6', 'placementPercent', 'headshotRatio']
...
SUM_LST = ['headshots', 'kills', 'deaths', 'distanceTraveled', 'damageDone', 'damageTaken', 'missionsComplete',
           ...
           'objectiveLastStandKill', 'objectiveReviver', 'objectiveTeamWiped',
